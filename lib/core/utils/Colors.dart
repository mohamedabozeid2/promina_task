...
class AppColors {
  static Color firstLoginColor = const Color(0xffDDCDFF);
  static Color thirdLoginColor = const Color(0xffFFDADA);
  static Color secondLoginColor = const Color(0xffEA94D7);
